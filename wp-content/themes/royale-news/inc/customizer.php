	...
	$wp_customize->add_section(
		new Royale_News_Customize_Section_Upsell(
			...
			array(
				...
				'pro_url'  => 'https://themebeez.com/downloads/royale-news-wordpress-premium-magazine-theme-pro-version/',
				'priority' => 1,
			)
		)
	);
...
function royale_news_customizer_js() {
    ...
    wp_enqueue_style( 'chosen', get_template_directory_uri() .'/themebeez/assets/css/chosen.css' );

    wp_enqueue_style( 'royale-news-upgrade', get_template_directory_uri() . '/themebeez/upgrade-to-pro/upgrade.css');

    wp_enqueue_style( 'royale-news-admin', get_template_directory_uri() . '/themebeez/assets/css/admin.css');
    ...
    wp_enqueue_script( 'chosen', get_template_directory_uri() .'/themebeez/assets/js/chosen.js', array('jquery'),'1.8.3', true  );   

	wp_enqueue_script( 'royale-news-admin', get_template_directory_uri() .'/themebeez/assets/js/admin.js', array('jquery'),'1.0.0', true  );  
}
